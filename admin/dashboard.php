	...
	<body>
		...
		<div class="content-wrapper">
			<div class="container mx-auto">
				...
				<section class="text-gray-600 body-font">
					<div class="container px-5 py-24 mx-auto">
						<h4 class="header-line text-md font-bold mb-5">USER YANG BARU SAJA MEMINJAM BUKU</h4>
										...
										<div
											...
											<div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
												<span
													...
													$query->execute();
													$result = $query->fetch(PDO::FETCH_OBJ); // Fetch single row as an object
													?>

													<?php if ($result) { ?>
														<?php echo htmlentities($result->FullName); ?>
													<?php } else { ?>
														<?php echo "Gagal menggambil nama user!"; ?>
													<?php } ?>
												</span>
												<span class="text-gray-900 inline-flex items-center leading-none text-sm">
													...
													</svg><?php echo date('d M Y', strtotime($result->IssuesDate)); ?>
												</span>
											</div>
										</div>
									</div>
